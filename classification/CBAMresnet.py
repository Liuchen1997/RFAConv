...
__all__ = ['ResNet', 'CBAMresnet18', 'CBAMresnet34', 'CBAMresnet50']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv1 = CBAMConv(inplanes,planes,3,stride)
...
def CBAMresnet18(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def CBAMresnet34(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def CBAMresnet50(pretrained=False, progress=True, **kwargs):
