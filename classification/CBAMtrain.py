...
def parse_args():
    ...
    parser.add_argument('--checkpoints',
                        type=str,
                        default="./models/CBAM/resnet34",
                        help='path for saving trained models')
    parser.add_argument('--log',
                        type=str,
                        default="./log/CBAM/resnet34",
                        help='path to save log')
    parser.add_argument('--evaluate',
                        type=str,
                        default=r'F:\class-test\models\CBAM\resnet34\models\latest.pth',
