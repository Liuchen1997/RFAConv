...
def parse_args():
    ...
    parser.add_argument('--checkpoints',
                        type=str,
                        default="./models/RFCA/resnet18",
                        help='path for saving trained models')
    parser.add_argument('--log',
                        type=str,
                        default="./log/RFCA/resnet18",
                        help='path to save log')
    parser.add_argument('--evaluate',
                        type=str,
                        default=r'F:\class-test\models\RFCA\resnet18\models\latest.pth',
