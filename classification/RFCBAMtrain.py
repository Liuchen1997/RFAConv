...
import RFACBAMresnet as modles
from utils.utils import DataPrefetcher, get_logger, AverageMeter, accuracy
...
def parse_args():
    ...
    parser.add_argument('--checkpoints',
                        type=str,
                        default="./models/RFCBAM/resnet18",
                        help='path for saving trained models')
    parser.add_argument('--log',
                        type=str,
                        default="./log/RFCBAM/resnet18",
                        help='path to save log')
    parser.add_argument('--evaluate',
                        type=str,
                        default=r'F:\class-test\models\RFCBAM\resnet18\models\latest.pth',
...
def main(logger, args):
    ...
    model = modles.__dict__[args.network](**{
    ...
    torch.save(model, os.path.join(args.checkpoints, 'best.pth'))
