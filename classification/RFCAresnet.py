...
__all__ = ['ResNet', 'RFCAresnet18', 'RFCAresnet34']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv1 = RFACAConv(inplanes,planes,3,stride)
...
def RFCAresnet18(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def RFCAresnet34(pretrained=False, progress=True, **kwargs):
