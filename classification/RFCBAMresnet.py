...
__all__ = ['ResNet', 'RFCBAMresnet18', 'RFCBAMresnet34']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv1 = RFACBAMConv(inplanes,planes,3,stride)
...
def RFCBAMresnet18(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def RFCBAMresnet34(pretrained=False, progress=True, **kwargs):
