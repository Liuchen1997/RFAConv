...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'F:\detect-test\detection\租gpu\yolov7\1\yolov7\yolov7-main\runs\train\yolov7-tiny-voc-32-RFAConv\weights\best_297.pt', help='model.pt path(s)')
